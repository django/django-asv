...
INSTALLED_APPS = [
    ...
    "benchmarks.query_benchmarks.operators.contains",
    "benchmarks.query_benchmarks.operators.icontains",
    "benchmarks.query_benchmarks.operators.endswith",
    "benchmarks.query_benchmarks.operators.iendswith",
    "benchmarks.query_benchmarks.operators.exact",
    "benchmarks.query_benchmarks.operators.iexact",
    "benchmarks.query_benchmarks.operators.startswith",
    "benchmarks.query_benchmarks.operators.istartswith",
